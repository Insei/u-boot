...
static const struct tegra_gpio_config mocha_gpio_inits[] = {
	/*        port, pin, init_val */
		GPIO_INIT(A, 	2, IN),
		GPIO_INIT(A,	3, IN),
		GPIO_INIT(G,	2, IN),
...
static const struct pmux_pingrp_config mocha_pingrps[] = {
...
static const struct pmux_drvgrp_config mocha_drvgrps[] = {
};
...
static const struct pmux_mipipadctrlgrp_config mocha_mipipadctrlgrps[] = {
	/*             grp,   mux */
};
